...
class RecipesProvider extends ChangeNotifier {
  ...
  getRecipes() async {
    try {
      ...
      dp(
          msg: "recipes list provider print",
          arg: recipes..toString().toString());
  ...
  ///----------------------------- Filter  Recipes based on meal type section ----------------------------------------
  String? selectedMealTypeFilter;

  updateMealTypeFilter(String val) {
    selectedMealTypeFilter = val;
    notifyListeners();
  }

  clearMealTypeFilter() {
    selectedMealTypeFilter = null;
    notifyListeners();
  }

  ///----------------------------- Filter  Recipes based on conditions section ----------------------------------------
  String? selectedConditionFilter;

  updateConditionFilter(String val) {
    selectedConditionFilter = val;
    notifyListeners();
  }
  ...
  ///----------------------------- Filter  Recipes based on diet type section ----------------------------------------
  String? selectedDietTypeFilter;

  updateDietTypeFilter(String val) {
    selectedDietTypeFilter = val;
    notifyListeners();
  }

  clearDietTypeFilter() {
    selectedDietTypeFilter = null;
    notifyListeners();
  }
}
