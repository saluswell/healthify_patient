...
import 'package:healthifi_patient/src/recipesSection/models/recipes_model.dart';
import 'package:healthifi_patient/src/recipesSection/screens/recipe_details.dart';
import 'package:healthifi_patient/src/recipesSection/widgets/dialog_helper.dart';
                      ...
                      if (model.planName == PlanName.FreePlan.name) ...[
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    DialogHelper.showMealTypeDialog();
                                  },
                                  child: Container(
                                    height: 45,
                                    width: 120,
                              ...
                              Expanded(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    DialogHelper.showRecipeConditionsDialog();
                                  },
                                  child: Container(
                                    height: 45,
                                    width: 120,
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    DialogHelper.showDietTypeDialog();
                                  },
                                  child: Container(
                                    height: 45,
                                    width: 120,
                        ...
                        StreamProvider.value(
                            value: recipesServices.streamRecipes(
                                mealTypeFilter: recipesProvider
                                            .selectedMealTypeFilter ==
                                        null
                                    ? "null"
                                    : recipesProvider.selectedMealTypeFilter
                                        .toString(),
                                conditions: recipesProvider
                                            .selectedConditionFilter ==
                                        null
                                    ? "null"
                                    : recipesProvider.selectedConditionFilter
                                        .toString(),
                                selectedDietType:
                                    recipesProvider.selectedDietTypeFilter ==
                                            null
                                        ? "null"
                                        : recipesProvider.selectedDietTypeFilter
                                            .toString()),
