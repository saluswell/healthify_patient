        ...
        actions: [
          Consumer<SearchProvider>(builder: (context, searchProvider, __) {
            return IconButton(
                onPressed: () {
                  setState(() {
                    searchProvider.selectedCountry = null;
                    searchProvider.selectedState = null;
                  });
                },
                icon: Icon(
                  Icons.refresh,
        ...
        children: [
            ...
            return Padding(
              ...
              child: CSCPicker(
                ...
                onCountryChanged: (value) {
                  setState(() {
                    searchProvider.selectedCountry = value;
                    // countryValue = value;
                  });
                  dp(
                      msg: "selected country ",
                      arg: searchProvider.selectedCountry);
                },
                onStateChanged: (value) {
                  setState(() {
                    searchProvider.selectedState = value;
                    // stateValue = value;
                  });
                  dp(msg: "selected state ", arg: searchProvider.selectedState);
                },
                onCityChanged: (value) {
                  setState(() {
                    searchProvider.selectedCity = value;
                    //cityValue = value;
                  });
                  dp(msg: "selected city ", arg: searchProvider.selectedCity);
                },
              ),
            );
          }),
          ...
          Consumer<SearchProvider>(builder: (context, searchProvider, __) {
            return StreamProvider.value(
                value: homeServices.streamCategoryWise(
                  userType: widget.userType,
                  selectedCountry: searchProvider.selectedCountry == null
                      ? "null"
                      : searchProvider.selectedCountry.toString(),
                  selectedState: searchProvider.selectedState == null
                      ? "null"
                      : searchProvider.selectedState.toString(),
                ),
