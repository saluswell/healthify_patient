...
import 'package:healthifi_patient/src/profileSection/widgets/ratingWidget.dart';
        ...
        Row(
          children: [
            Column(
              ...
              children: [
                CacheNetworkImageWidget(
                  imgUrl: reviewModel.dietitianProfilePic.toString(),
                  height: 55,
                  width: 55,
                  radius: 11,
                )
            ...
            Column(
              ...
              children: [
                Text(
                  reviewModel.dietitianName.toString(),
